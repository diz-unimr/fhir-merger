...
public class ProcessorTests {
    ...
    @Test
    public void buildPipeline_ConfiguresProcessor() {
        ...
        try (var driver = new TopologyTestDriver(builder.build())) {
            ...
            var testTopic = driver.createInputTopic(topicName, new StringSerializer(),
                new FhirSerializer<>());
            var outputTopic = driver.createOutputTopic(outputTopicName, new StringDeserializer(),
